...
export default function Footer() {
  ...
  return (
    <footer className="border-t border-border bg-bone-soft px-5 sm:px-8">
      <div className="mx-auto grid max-w-7xl gap-14 py-20 md:grid-cols-[1.5fr_1fr_1fr_1fr]">
        {/* BRAND */}
        <div>
        ...
        {/* MAISON */}
        <div>
          <p className="mb-5 text-eyebrow font-medium uppercase text-sand">MAISON</p>
          <div className="grid gap-3">
            <Link href="/#world" className="text-sm text-ink-soft hover:text-tangier">
              {isFr ? "Notre monde" : "Our world"}
            </Link>
            <Link href="/account" className="text-sm text-ink-soft hover:text-tangier">
